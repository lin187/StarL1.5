...
public class MavicBTI implements ARDiscoveryServicesDevicesListUpdatedReceiverDelegate, DeviceControllerListener {
    ...
    public MavicBTI(GlobalVarHolder gvh, Context context, String mac) {
