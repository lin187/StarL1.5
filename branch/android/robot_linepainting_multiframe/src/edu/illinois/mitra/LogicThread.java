...
import edu.illinois.mitra.functions.BarrierSynchronizer;
import edu.illinois.mitra.functions.RandomLeaderElection;
import edu.illinois.mitra.functions.SingleHopMutualExclusion;
import edu.illinois.mitra.interfaces.LeaderElection;
...
//	public static final int STAGE_DONE = 99;
	...
	public static final int MSG_INFORMLINE 				= 7;
	public static final int MSG_LINEPROGRESS 			= 8;
	...
	public void run() {
		while(running) {
			...
			case LEADERELECT:
				LeaderElection le = new RandomLeaderElection(gvh);
				leader = le.elect();
			...
			case GET_LINE_ASSIGNMENT:
				...
				assignment.parseAssignmentMessage(gvh.getIncomingMessages(MSG_INFORMLINE).iterator().next());
