...
public class RandomLeaderElection implements LeaderElection, MessageListener {
	...
	private void registerListeners() {
		gvh.addMsgListener(LogicThread.MSG_LEADERELECT, this);
		gvh.addMsgListener(LogicThread.MSG_LEADERELECT_ANNOUNCE, this);
	}

	private void unregisterListeners() {
		gvh.removeMsgListener(LogicThread.MSG_LEADERELECT);
		gvh.removeMsgListener(LogicThread.MSG_LEADERELECT_ANNOUNCE);		
	}
	
	public void messageReceied(RobotMessage m) {
		switch(m.getMID()) {
		case LogicThread.MSG_LEADERELECT:
		...
		case LogicThread.MSG_LEADERELECT_ANNOUNCE:
