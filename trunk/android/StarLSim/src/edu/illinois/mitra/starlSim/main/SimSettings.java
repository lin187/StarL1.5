...
public class SimSettings {
	...
	public static String	 	waypoint_file		= "C:/gpstest.wpt";		// Path to a .wpt file with waypoints
	public static String 		initial_positions 	= null;				// Path to a .wpt file with positions or null to enable random starting locations
	public static Class<?> 		app 				= LineFollowingApp.class;	// The application to be simulated
	//edu.illinois.mitra.lightpaint.main.AppLogic.class
	public static boolean		IDEAL_MOTION		= true;			// True enables ideal movement, false uses the simulated motion automaton
	public static double		TIC_TIME_RATE		= 25.0;				// The desired rate of time passing. 0 = no limit, 0.5 = half real-time, 1.0 = real-time, etc. 
	...
	// Initial start delay
	public static int			START_DELAY_MAX	= 5;			// Milliseconds
