...
import edu.illinois.mitra.starlSim.simapps.CircleFormation;
...
public class SimSettings {
	...
	public static int 			N_BOTS 				= 1;					// The number of robots to simulate
	...
	public static Class<? extends LogicThread> 		app = CircleMotion.class; // The application to be simulated
